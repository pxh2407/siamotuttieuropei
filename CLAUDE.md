...
- **Logo LUTE** (17/07/2026): `logo-lute.png` (verde, trasparente, ridotto da 4096px a 600×287, 69 KB — originale in `CLAUDE\Logo Lute.png`) in cima al `.pannello` (`<img id="logoLute">`, ~190px, centrato). Visibile nella vista Pannello.
